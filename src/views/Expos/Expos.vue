            ...
            <div class="row">
                <div class="col-md-12 text-center">
                        <div class="btn-group w-25 mb-5" role="group" aria-label="Basic radio toggle button group">
                            ...
                            <label class="btn btn-outline-secondary" for="btnradio1">Pasadas</label>
                            ...
                            <label class="btn btn-outline-secondary" for="btnradio2">Actuales</label>
                            ...
                            <label class="btn btn-outline-secondary" for="btnradio3">Próximas</label>
                        </div>
                </div>
            </div>
